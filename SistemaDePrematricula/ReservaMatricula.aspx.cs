...
namespace SistemaDePrematricula
{
    ...
    {
        protected void Page_LoadReservarMat(object sender, EventArgs e)
        {

        }
        [WebMethod]
        public static AlumnoServWS.Alumno Reservar(string login, string clave)
        {
            try
            {
        ...
        [WebMethod]
        public static String ReservarMat()
        {
            try
            {
                AlumnoServiceClient alumnoService = new AlumnoServiceClient();
