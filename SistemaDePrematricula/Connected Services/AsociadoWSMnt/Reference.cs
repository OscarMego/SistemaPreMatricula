...
namespace SistemaDePrematricula.AsociadoWSMnt {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="AsociadoWSMnt.IRegistroService")]
    public interface IRegistroService {
        ...
        [System.ServiceModel.FaultContractAttribute(typeof(SistemaDePrematricula.AsociadoWSMnt.ManejadorException), Action="http://tempuri.org/IRegistroService/CrearAsociadoManejadorExceptionFault", Name="ManejadorException", Namespace="http://schemas.datacontract.org/2004/07/ServicioSITECE.Errores")]
        SistemaDePrematricula.AsociadoWSMnt.Asociado CrearAsociado(SistemaDePrematricula.AsociadoWSMnt.Asociado asociado);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IRegistroService/CrearAsociado", ReplyAction="http://tempuri.org/IRegistroService/CrearAsociadoResponse")]
        System.Threading.Tasks.Task<SistemaDePrematricula.AsociadoWSMnt.Asociado> CrearAsociadoAsync(SistemaDePrematricula.AsociadoWSMnt.Asociado asociado);
        ...
        SistemaDePrematricula.AsociadoWSMnt.Asociado ObtenerAsociado(string token, string codigoModular);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IRegistroService/ObtenerAsociado", ReplyAction="http://tempuri.org/IRegistroService/ObtenerAsociadoResponse")]
        System.Threading.Tasks.Task<SistemaDePrematricula.AsociadoWSMnt.Asociado> ObtenerAsociadoAsync(string token, string codigoModular);
        ...
        SistemaDePrematricula.AsociadoWSMnt.Asociado ObtenerAsociadoToken(string token);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IRegistroService/ObtenerAsociadoToken", ReplyAction="http://tempuri.org/IRegistroService/ObtenerAsociadoTokenResponse")]
        System.Threading.Tasks.Task<SistemaDePrematricula.AsociadoWSMnt.Asociado> ObtenerAsociadoTokenAsync(string token);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IRegistroServiceChannel : SistemaDePrematricula.AsociadoWSMnt.IRegistroService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class RegistroServiceClient : System.ServiceModel.ClientBase<SistemaDePrematricula.AsociadoWSMnt.IRegistroService>, SistemaDePrematricula.AsociadoWSMnt.IRegistroService {
        ...
        public SistemaDePrematricula.AsociadoWSMnt.Asociado CrearAsociado(SistemaDePrematricula.AsociadoWSMnt.Asociado asociado) {
            return base.Channel.CrearAsociado(asociado);
        }
        
        public System.Threading.Tasks.Task<SistemaDePrematricula.AsociadoWSMnt.Asociado> CrearAsociadoAsync(SistemaDePrematricula.AsociadoWSMnt.Asociado asociado) {
            return base.Channel.CrearAsociadoAsync(asociado);
        }
        
        public SistemaDePrematricula.AsociadoWSMnt.Asociado ObtenerAsociado(string token, string codigoModular) {
            return base.Channel.ObtenerAsociado(token, codigoModular);
        }
        
        public System.Threading.Tasks.Task<SistemaDePrematricula.AsociadoWSMnt.Asociado> ObtenerAsociadoAsync(string token, string codigoModular) {
            return base.Channel.ObtenerAsociadoAsync(token, codigoModular);
        }
        
        public SistemaDePrematricula.AsociadoWSMnt.Asociado ObtenerAsociadoToken(string token) {
            return base.Channel.ObtenerAsociadoToken(token);
        }
        
        public System.Threading.Tasks.Task<SistemaDePrematricula.AsociadoWSMnt.Asociado> ObtenerAsociadoTokenAsync(string token) {
