...
namespace ServicioSITECEDelete.AsociadoWSDel {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="AsociadoWSDel.IRegistroService")]
    public interface IRegistroService {
        ...
        [System.ServiceModel.FaultContractAttribute(typeof(ServicioSITECEDelete.AsociadoWSDel.ManejadorException), Action="http://tempuri.org/IRegistroService/CrearAsociadoManejadorExceptionFault", Name="ManejadorException", Namespace="http://schemas.datacontract.org/2004/07/ServicioSITECE.Errores")]
        ServicioSITECEDelete.AsociadoWSDel.Asociado CrearAsociado(ServicioSITECEDelete.AsociadoWSDel.Asociado asociado);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IRegistroService/CrearAsociado", ReplyAction="http://tempuri.org/IRegistroService/CrearAsociadoResponse")]
        System.Threading.Tasks.Task<ServicioSITECEDelete.AsociadoWSDel.Asociado> CrearAsociadoAsync(ServicioSITECEDelete.AsociadoWSDel.Asociado asociado);
        ...
        ServicioSITECEDelete.AsociadoWSDel.Asociado ObtenerAsociado(string token, string codigoModular);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IRegistroService/ObtenerAsociado", ReplyAction="http://tempuri.org/IRegistroService/ObtenerAsociadoResponse")]
        System.Threading.Tasks.Task<ServicioSITECEDelete.AsociadoWSDel.Asociado> ObtenerAsociadoAsync(string token, string codigoModular);
        ...
        ServicioSITECEDelete.AsociadoWSDel.Asociado ObtenerAsociadoToken(string token);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IRegistroService/ObtenerAsociadoToken", ReplyAction="http://tempuri.org/IRegistroService/ObtenerAsociadoTokenResponse")]
        System.Threading.Tasks.Task<ServicioSITECEDelete.AsociadoWSDel.Asociado> ObtenerAsociadoTokenAsync(string token);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IRegistroServiceChannel : ServicioSITECEDelete.AsociadoWSDel.IRegistroService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class RegistroServiceClient : System.ServiceModel.ClientBase<ServicioSITECEDelete.AsociadoWSDel.IRegistroService>, ServicioSITECEDelete.AsociadoWSDel.IRegistroService {
        ...
        public ServicioSITECEDelete.AsociadoWSDel.Asociado CrearAsociado(ServicioSITECEDelete.AsociadoWSDel.Asociado asociado) {
            return base.Channel.CrearAsociado(asociado);
        }
        
        public System.Threading.Tasks.Task<ServicioSITECEDelete.AsociadoWSDel.Asociado> CrearAsociadoAsync(ServicioSITECEDelete.AsociadoWSDel.Asociado asociado) {
            return base.Channel.CrearAsociadoAsync(asociado);
        }
        
        public ServicioSITECEDelete.AsociadoWSDel.Asociado ObtenerAsociado(string token, string codigoModular) {
            return base.Channel.ObtenerAsociado(token, codigoModular);
        }
        
        public System.Threading.Tasks.Task<ServicioSITECEDelete.AsociadoWSDel.Asociado> ObtenerAsociadoAsync(string token, string codigoModular) {
            return base.Channel.ObtenerAsociadoAsync(token, codigoModular);
        }
        
        public ServicioSITECEDelete.AsociadoWSDel.Asociado ObtenerAsociadoToken(string token) {
            return base.Channel.ObtenerAsociadoToken(token);
        }
        
        public System.Threading.Tasks.Task<ServicioSITECEDelete.AsociadoWSDel.Asociado> ObtenerAsociadoTokenAsync(string token) {
